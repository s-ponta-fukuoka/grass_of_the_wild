...
#include "../object/canvas/game_over/game_over.h"
...
// 初期化処理
///////////////////////////////////////////////////////////////////////////////
HRESULT GameOverScene::Init(NextScene* pNextScene,
	...
	EffectManager* pEffectManager)
{
	...
	pWwise->MainListenerGameObjEvent(EVENTS::GAME_OVER);
	...
	m_pCanvasManager->AddCanvas(new GameOver(m_pRenderManager, m_pShaderManager, m_pTextureManager));
...
void GameOverScene::Update()
{
	...
	if (pInputKeyboard->GetKeyTrigger(DIK_RETURN) || Xinput.Gamepad.wButtons == XINPUT_GAMEPAD_A)
	{
